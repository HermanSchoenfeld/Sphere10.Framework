...
public partial class PostgreSQLConnectionPanel : ConnectionPanelBase {
	public PostgreSQLConnectionPanel() {
		InitializeComponent();
	}

	protected override IDAC GetDACInternal() {
		return new PostgreSQLDAC(ConnectionString);
	}
	...
	public override string ConnectionString {
		get {
			...
			builder.Host = _serverTextBox.Text;
			builder.Database = _databaseTextBox.Text;
			builder.Username = _usernameTextBox.Text;
		...
		set {
			...
			_serverTextBox.Text = builder.Host;
			_databaseTextBox.Text = builder.Database;
			_usernameTextBox.Text = builder.Username;
			_passwordTextBox.Text = builder.Password;
			_portTextBox.Text = builder.Port != 5432 ? builder.Port.ToString() : string.Empty;
		}
	}
