...
public partial class ProductProductRequestFeatureDialog : ApplicationForm, IProductRequestFeatureDialog {
	...
	public ProductProductRequestFeatureDialog() {
		InitializeComponent();
		UserInterfaceServices = Sphere10Framework.Instance.ServiceProvider.GetService<IUserInterfaceServices>();
	}
	...
	private void _sendButton_Click(object sender, EventArgs e) {
		...
		try {
			...
			//ISphere10SoftwareService2 softwareService = Sphere10Framework.Instance.ServiceProvider.GetService<ISphere10SoftwareService2>();
