...
public class ItemDigestor<TItem> : ItemSerializerDecorator<TItem>, IItemHasher<TItem>, IItemChecksummer<TItem> {
	...
	public ItemDigestor(IItemSerializer<TItem> internalSerializer, Endianness endianness = Sphere10FrameworkDefaults.Endianness)
		: this(CHF.SHA2_256, internalSerializer, endianness) {
	}

	public ItemDigestor(CHF hashAlgorithm, IItemSerializer<TItem> internalSerializer = null, Endianness endianness = Sphere10FrameworkDefaults.Endianness)
