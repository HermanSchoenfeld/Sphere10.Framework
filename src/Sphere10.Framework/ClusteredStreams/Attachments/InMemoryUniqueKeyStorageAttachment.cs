...
public class InMemoryUniqueKeyStorageAttachment<TKey> : PagedListStorageAttachmentBase<TKey>, IReadOnlyDictionary<TKey, long> {
	
	private readonly Dictionary<TKey, long> _dictionary;

	public InMemoryUniqueKeyStorageAttachment(ClusteredStreams streams, string attachmentID, IItemSerializer<TKey> keySerializer, IEqualityComparer<TKey> keyComparer)
