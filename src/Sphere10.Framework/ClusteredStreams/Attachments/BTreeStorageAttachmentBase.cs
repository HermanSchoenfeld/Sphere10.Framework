...
/// </summary>
public abstract class BTreeStorageAttachmentBase<TKey, TValue> : ClusteredStreamsAttachmentBase {
	...
	public BTreeStorageAttachmentBase(
	...
	protected StreamMappedBTree<TKey, TValue> BTree {
		get {
			CheckAttached();
			return _btree;
		}
