...
public class InMemoryIndexStorageAttachment<TData> : PagedListStorageAttachmentBase<TData>, ILookup<TData, long> {

	private readonly ExtendedLookup<TData, long> _lookup;

	public InMemoryIndexStorageAttachment(ClusteredStreams streams, string attachmentID, IItemSerializer<TData> datumSerializer, IEqualityComparer<TData> datumComparer)
